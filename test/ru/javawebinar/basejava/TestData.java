...
public class TestData {
    ...
    static {
        ...
        R1.addSection(SectionType.ACHIEVEMENT, new ListSection(new ArrayList<>(Arrays.asList("Achievement11", "Achievement12", "Achievement13"))));
        R1.addSection(SectionType.QUALIFICATIONS, new ListSection(new ArrayList<>(Arrays.asList("Java", "SQL", "JavaScript"))));
